# Prompt 09: Agent 11 - Monitor Agent

## Wat deze prompt bouwt

Monitor Agent voor NOVA v2 pipeline.

## Voorwaarden

- [ ] Prompt 08 compleet
- [ ] agent_08_status.json toont "active" of "fallback_mode"

## De prompt

```
Bouw Agent 11 - Monitor Agent voor NOVA v2.

CONTEXT:
- Spec: L:\!Nova V2\agents\nova_v2_agents\operational\11_monitor_agent.md
- Target: L:\!Nova V2\v2_services\agent_11_monitor\
- Hetzner: /docker/nova-v2/services/agent_11_monitor/
- Webhook: http://178.104.207.194:5680/webhook/monitor
- Port intern: 8111
...
10. Status file schrijven naar L:\!Nova V2\status\agent_11_status.json
...
Invoke-RestMethod -Uri "http://178.104.207.194:5680/webhook/monitor" -Method POST -Body $testBody -ContentType "application/json"

# Check status
Get-Content "L:\!Nova V2\status\agent_11_status.json" | ConvertFrom-Json
```
...
- Check container logs: `ssh root@178.104.207.194 "cd /docker/nova-v2 && docker compose logs agent-11-monitor"`
- Check dependencies geïnstalleerd als host tools nodig zijn


## Volgende prompt

`01_fase1_foundation/prompt_10_agent_*.md` (zie PROMPT_INDEX.md)
