# Prompt 20: Agent 30 - Audio Asset Jury

## Wat deze prompt bouwt

Audio Asset Jury voor NOVA v2 pipeline.

## Voorwaarden

- [ ] Prompt 19 compleet
- [ ] agent_19_status.json toont "active" of "fallback_mode"

## De prompt

```
Bouw Agent 30 - Audio Asset Jury voor NOVA v2.

CONTEXT:
- Spec: L:\!Nova V2\extensions\nova_v2_extensions\audio\30_audio_asset_jury.md
- Target: L:\!Nova V2\v2_services\agent_30_audio_asset_jury\
- Hetzner: /docker/nova-v2/services/agent_30_audio_asset_jury/
- Webhook: http://178.104.207.194:5680/webhook/audio-asset-review
- Port intern: 8130
...
gameplay_context, integration_quality

ENDPOINTS:
/review/context, /review/integration
...
10. Status file schrijven naar L:\!Nova V2\status\agent_30_status.json
...
- Agent 30 Audio Asset Jury status
- Webhook URL
- Test resultaten  
...
Invoke-RestMethod -Uri "http://178.104.207.194:5680/webhook/audio-asset-review" -Method POST -Body $testBody -ContentType "application/json"

# Check status
Get-Content "L:\!Nova V2\status\agent_30_status.json" | ConvertFrom-Json
```
...
- Check container logs: `ssh root@178.104.207.194 "cd /docker/nova-v2 && docker compose logs agent-30-audio_asset_jury"`
- Check dependencies geïnstalleerd als host tools nodig zijn


## Volgende prompt

`03_fase3_polish/prompt_21_agent_*.md` (zie PROMPT_INDEX.md)
