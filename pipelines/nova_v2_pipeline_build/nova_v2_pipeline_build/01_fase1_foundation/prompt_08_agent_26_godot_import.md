# Prompt 08: Agent 26 - Godot Import

## Wat deze prompt bouwt

Godot Import voor NOVA v2 pipeline.

## Voorwaarden

- [ ] Prompt 07 compleet
- [ ] agent_07_status.json toont "active" of "fallback_mode"

## De prompt

```
Bouw Agent 26 - Godot Import voor NOVA v2.

CONTEXT:
- Spec: L:\!Nova V2\extensions\nova_v2_extensions\godot\26_godot_import_agent.md
- Target: L:\!Nova V2\v2_services\agent_26_godot_import\
- Hetzner: /docker/nova-v2/services/agent_26_godot_import/
- Webhook: http://178.104.207.194:5680/webhook/godot-import
- Port intern: 8126
...
import_settings, scene_structure, runtime_integration_tester

ENDPOINTS:
/import/generate, /scene/generate, /script/generate

DEPENDENCIES:
jinja2 (Godot 4.x headless on host)
...
10. Status file schrijven naar L:\!Nova V2\status\agent_26_status.json
...
Invoke-RestMethod -Uri "http://178.104.207.194:5680/webhook/godot-import" -Method POST -Body $testBody -ContentType "application/json"

# Check status
Get-Content "L:\!Nova V2\status\agent_26_status.json" | ConvertFrom-Json
```
...
- Check container logs: `ssh root@178.104.207.194 "cd /docker/nova-v2 && docker compose logs agent-26-godot_import"`
- Check dependencies geïnstalleerd als host tools nodig zijn


## Volgende prompt

`01_fase1_foundation/prompt_09_agent_*.md` (zie PROMPT_INDEX.md)
